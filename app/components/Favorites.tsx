export default function footer(){
    return(
        <div className={"flex p-4 justify-items-center self-center flex-row border-2 border-slate-900 gap-y-3 text-4xl my-8"}>
            <div>Favorite </div>
            <div
                className={"h-14 w-full pt-4 pl-2 overflow-y-scroll overflow-x-visible snap-y snap-mandatory text-left text-nowrap text "}>
                ...
                <p className={"overflow-x-visible snap-start snap-mandatory pb-4"}>FRC team: 114 Eaglestrike!!!!</p>
