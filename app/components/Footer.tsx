...
export default function Footer(){
    ...
    return(
        <div className={"bg-slate-900 flex flex-col gap-2 py-8 pl-6"}>
            ...
            <div className={"text-left text-white"}>
                ...
                <div className={"flex flex-row gap-3"}>
                    <div>
                        <a className={''} href={'https://github.com/edward-j-liu'}>
                            <svg
                    ...
                    <div>
                        <a className={''} href={'https://www.instagram.com/eddie.j.l/?hl=en'}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="36"
                                height="36"
                    ...
                    <div>
                        <a className={''} href={'https://www.chess.com/member/drjohn_chess'}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="36"
                                height="36"
