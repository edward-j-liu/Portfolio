    ...
    return(
        ...
        <div className={"flex flex-col bg-white indent-12"}>
            ...
            <div className={"md:px-52 sm:px-40 md:pt-20 sm:pt-10 text-2xl pb-40"}>
                <p className={"py-7"}>The most stressful part of robotics this year was the off-season competitions. Not
                    only did I have an immense amount of responsibilities on the two-three days of the competitions, all
                    the while I would also be falling behind on homework from other classes.
                </p>

                <div className={"flex flex-row"}>
                    <p className={"py-7 mr-2"}>As the scouting lead, I was to keep track of 12 (or more) rowdy students,
                        some
                        were older than me, most were my peers. This made me sympathize with wanting to play games, yet
                        I
                        still had to push them to scout. I tried to make schedules more lenient so that they would have
                        longer breaks, but sometimes there was simply not enough manpower to do so. Not only did I have
                        to ensure the data was being collected, I would also have to be vigilant for clearly wrong data.
                        Because many students were new to robotics, I also had to teach
                        them the rules game and how to use the app, which is becoming more complicated for the sake of
                        more complete
                ...
                <p className={"py-7"}>  This year, for the first time, we had a dedicated pit strategist, Zoe Cheng. I
                    worked
                ...
                <p className={"py-7"}>
                    ...
                    <p className={"py-7"}> It was not all bad, however, every travel competition came with the
                        opportunity to get to know the team better, to mess about in the hotel lobby. This year, I was
                        proud to continue the tradition of Team 114 apple cider, and nightly mahjong games.
                    </p>
